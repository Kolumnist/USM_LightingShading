...
function getUIElement() {
    canvas = document.getElementById("gl-canvas");
    cameraPosition = document.getElementById("camera-position");
    dropdownSelect = document.getElementById("object-select"); // Ensure this matches the HTML
...
// Draw the second shape (sphere)
function drawSphere() {
    modelViewMatrix = mat4();
    modelViewMatrix = mult(modelViewMatrix, lookAt(eye, at, up));
    modelViewMatrix = mult(modelViewMatrix, translate(2, 0, 0)); // Translate sphere
    gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix));
...
// Draw the third shape (cube)
function drawCube() {
    modelViewMatrix = mat4();
    modelViewMatrix = mult(modelViewMatrix, lookAt(eye, at, up));
    modelViewMatrix = mult(modelViewMatrix, translate(-2, 0, 0)); // Translate cube
    gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix));
